...
INTERVAL_JOBS = (
    ("download_cleanup", "_retry_download_cleanup", "Completed download cleanup retries", "minutes", 2, 1, 1440),
    ("library_reconcile", "_reconcile_filed_library", "Post-processing library checks", "minutes", 2, 1, 1440),
