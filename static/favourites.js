      ...
      ? `<div class="discover-info-scenes discover-info-scenes--studio">${scenes.map(s => {
          ...
          return `<div class="scene-card discover-info-scene-card">
            ...
            <div class="entity-scene-prowlarr-overlay">
              <button type="button" class="fav-icon-btn entity-scene-prowlarr" onclick="window.openProwlarrSearchPopup({title:${titleJson},studio:${studioJson},source:${sourceJson},ext_id:${sidJson},kind:'scene'})" title="Search Prowlarr"><img src="/static/logos/prowlarr.webp" alt="Prowlarr" onerror="this.replaceWith(Object.assign(document.createElement('i'),{className:'fa-solid fa-magnifying-glass'}))"><i class="fa-solid fa-magnifying-glass"></i></button>
            </div>
          </div>`;
        }).join('')}</div>`
