/* Externalized from favourites.html. */
  ...
  function _consumeLibraryInvalidation() {
    ...
    // Stale flags older than 5 min shouldn't force a refresh — the
    // grid was likely refreshed since via some other path.
    if (Date.now() - (payload.ts || 0) > 5 * 60 * 1000) return;
