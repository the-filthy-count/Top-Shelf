...
(function () {
  ...
  const NAV_SHORT_LABELS = {
    ...
    "Download Indexer Feeds": "Releases",
    "Queue": "Unmatched",
    "Unmatched": "Unmatched",
  };
  ...
  function renderSidebar(sidebar, entries) {
    ...
    sidebar.innerHTML =
      '<a href="/unmatched" class="ts-sidebar__brand" title="Top-Shelf">' +
      ...
      (version ? '<div class="ts-sidebar__version">' + version.replace(/[<>&"]/g, "") + '</div>' : "") +
      '</div>';
