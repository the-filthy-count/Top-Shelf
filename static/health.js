...
/* Block 1/3: main /health page logic. */
  ...
  async function renderDetail() {
    ...
    if (key === 'orphaned') {
      ...
      headAct.style.display = '';
      headAct.innerHTML = '<button type="button" class="btn-icon-danger btn-head-bulk-delete" id="btnRemoveAllOrphans" title="Remove all" aria-label="Remove all from history"><i class="fa-solid fa-xmark" aria-hidden="true"></i></button>';
