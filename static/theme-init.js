...
(function () {
  ...
  var THEMES = ['auto', 'dark', 'light', 'nord', 'solarized', 'dracula', 'tokyo-night', 'gruvbox', 'catppuccin-latte', 'catppuccin-frappe', 'catppuccin-macchiato', 'catppuccin-mocha', 'custom'];
      ...
      if (raw) {
        ...
        if (overrides && typeof overrides === 'object') {
          Object.keys(overrides).forEach(function (k) {
            if (overrides[k]) _rebuildDuotoneFilterNode('duotone-' + k, overrides[k]);
          });
        }
      }
