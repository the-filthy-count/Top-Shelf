    ...
    el.innerHTML = '<div class="pp-scenes-grid studio-popup-pp-scenes">'
      + scenes.slice(0, 12).map((s) => {
        ...
        const sourceLink = url
          ...
          : '';
        const prowlarrBtn = `<button type="button" class="pp-scene-prowlarr-center" onclick="event.stopPropagation(); window.openProwlarrSearchPopup&&window.openProwlarrSearchPopup({title:${titleJson},studio:${studioJson},source:${sourceJson},ext_id:${sidJson},kind:'scene'})" title="Search Prowlarr" aria-label="Search Prowlarr">
