...
_FAKE_KEYS = {"stashdb": "k-stash", "tpdb": "k-tpdb", "fansdb": "k-fansdb"}
...
class QueryWithFallbackTests(unittest.TestCase):
    ...
    def test_all_three_exceptions_raises_runtime_error(self) -> None:
        """If even FansDB blows up the function should raise — silent
        ...
        self.assertIn("FansDB", str(ctx.exception))
